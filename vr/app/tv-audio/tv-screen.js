...
var TVScreen = function(){
    ...
    this.uniforms = {
        ...
        texture : { type: "t",  value: window.app.assets.texture.audioOn }
    };
...
TVScreen.prototype.turnOn = function(){
    ...
    tl.to(this.tvMaterial.uniforms.uState, 0.2, {value: 0.1, ease: Quint.easeIn })
        ...
        .to(this.tvMaterial.uniforms.uState, 0.3, {value: 0.4 })
...
TVScreen.prototype.onClick = function(isAudio){
    //var tl = new TimelineMax();a
    //this.isClick = true;
    if(this.auTl) this.auTl.pause();
    var targetVal
    if(isAudio) targetVal = 1;
    else        targetVal = 0;
    this.auTl = TweenMax.to(this.tvMaterial.uniforms.uRate, 0.6, {value: targetVal, onComplete: function(){
        setTimeout(function(){this.dispatchEvent({type: "mouseEnable"});}.bind(this), 1000);
    }.bind(this)});
